...
class SPFeedItem: NSObject {
    ...
    func setupWithServerFeedItem( serverFeedItem: Dictionary<String, AnyObject> ) {
        ...
        let commentsPhoto1 = comments[ "commentsPhoto1" ] as! Array<SPActivity>
        self.comments.commentsPhotoOne = commentsPhoto1
        let commentsPhoto2 = comments[ "commentsPhoto2" ] as! Array<SPActivity>
        ...
        PFObject.fetchAllIfNeededInBackground(usersToFetchIfNeeded)
    }
}
